...
class CreateFeServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Fe_services", 'fe_services', 'services_title', 'fa-android', [
            ...
            ["services_power", "Power", "Dropdown", false, "", 0, 0, true, ["1 - 1.5hp","2 - 2.5hp","3 - 3.5hp","4 - 4.5hp"]],
    ...
    {
        if (Schema::hasTable('fe_services')) {
            Schema::drop('fe_services');
        }
    }
}
