...
class CreateFrontendOrdersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Frontend_orders", 'frontend_orders', 'order_typemachine', 'fa-bullhorn', [
            ["order_typemachine", "Loại máy lạnh", "TextField", false, "", 0, 256, true],
            ["order_power", "Công suất", "String", false, "", 0, 256, true],
            ["order_amount", "Số lượng", "Integer", false, "", 1, 11, true],
            ["grouporder_id", "Group Order", "Integer", false, "", 0, 11, true],
        ]);
