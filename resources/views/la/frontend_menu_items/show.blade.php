...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $frontend_menu_item->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Frontend_menu_items", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/frontend_menu_items/'.$frontend_menu_item->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Frontend_menu_items", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.frontend_menu_items.destroy', $frontend_menu_item->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/frontend_menu_items') }}" data-toggle="tooltip" data-placement="right" title="Back to Frontend menu items"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'menu_position')
						@la_display($module, 'menu_parent_id')
						@la_display($module, 'menu_link')
						@la_display($module, 'menu_action')
					</div>
				</div>
			</div>
		</div>
