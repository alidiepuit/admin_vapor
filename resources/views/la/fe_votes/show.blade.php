...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $fe_vote->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("FE_votes", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/fe_votes/'.$fe_vote->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("FE_votes", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.fe_votes.destroy', $fe_vote->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/fe_votes') }}" data-toggle="tooltip" data-placement="right" title="Back to FE votes"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'vote_grouporder')
						@la_display($module, 'vote_star')
						@la_display($module, 'vote_comment')
						@la_display($module, 'vote_user')
					</div>
				</div>
			</div>
		</div>
