...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $fe_service_tool->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("FE_Service_Tools", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/fe_service_tools/'.$fe_service_tool->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("FE_Service_Tools", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.fe_service_tools.destroy', $fe_service_tool->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/fe_service_tools') }}" data-toggle="tooltip" data-placement="right" title="Back to FE Service Tools"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'tool_power')
						@la_display($module, 'tool_title')
						@la_display($module, 'tool_unit')
						@la_display($module, 'tool_cost')
					</div>
				</div>
			</div>
		</div>
