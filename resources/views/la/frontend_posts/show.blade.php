...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $frontend_post->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Frontend_posts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/frontend_posts/'.$frontend_post->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Frontend_posts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.frontend_posts.destroy', $frontend_post->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/frontend_posts') }}" data-toggle="tooltip" data-placement="right" title="Back to Frontend posts"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'post_title')
						@la_display($module, 'post_slug')
						@la_display($module, 'post_content')
						@la_display($module, 'post_image')
						@la_display($module, 'post_status')
						@la_display($module, 'post_create_by')
						@la_display($module, 'post_type')
					</div>
				</div>
			</div>
		</div>
