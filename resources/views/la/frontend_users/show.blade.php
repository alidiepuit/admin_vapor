...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $frontend_user->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Frontend_users", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/frontend_users/'.$frontend_user->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Frontend_users", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.frontend_users.destroy', $frontend_user->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/frontend_users') }}" data-toggle="tooltip" data-placement="right" title="Back to Frontend users"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'user_password')
						@la_display($module, 'user_type_login')
						@la_display($module, 'user_display_name')
						@la_display($module, 'user_address')
						@la_display($module, 'user_phone')
						@la_display($module, 'user_active')
					</div>
				</div>
			</div>
		</div>
