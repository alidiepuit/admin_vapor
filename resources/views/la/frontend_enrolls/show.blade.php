...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $frontend_enroll->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Frontend_enrolls", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/frontend_enrolls/'.$frontend_enroll->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Frontend_enrolls", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.frontend_enrolls.destroy', $frontend_enroll->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/frontend_enrolls') }}" data-toggle="tooltip" data-placement="right" title="Back to Frontend enrolls"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'enroll_fullname')
						@la_display($module, 'enroll_email')
						@la_display($module, 'enroll_phone')
						@la_display($module, 'enroll_gender')
						@la_display($module, 'enroll_identifier')
						@la_display($module, 'enroll_issueby')
						@la_display($module, 'enroll_issueon')
						@la_display($module, 'enroll_address')
						@la_display($module, 'enroll_marital')
						@la_display($module, 'enroll_healthy')
						@la_display($module, 'enroll_experience')
						@la_display($module, 'enroll_year')
						@la_display($module, 'enroll_skills')
						@la_display($module, 'enroll_tools')
						@la_display($module, 'enroll_know')
						@la_display($module, 'enroll_acceptterms')
						@la_display($module, 'enroll_tempaddress')
					</div>
				</div>
			</div>
		</div>
